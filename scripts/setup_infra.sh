...
awslocal sqs set-queue-attributes --queue-url http://localhost:4566/000000000000/my_queue --attributes file://$PWD/scripts/attributes.json

awslocal lambda update-function-configuration --function-name myLambda --environment file://$PWD/scripts/environment.json
